...
class CacheKeyPrefix(StrEnum):
    ...
    NBA_ELBOW_TOUCH = "nba:elbow_touch"
    NBA_POST_TOUCH = "nba:post_touch"
    NBA_PAINT_TOUCH = "nba:paint_touch"
    NBA_DEFENSE_2PT = "nba:defense_2pt"
    NBA_DEFENSE_LONG_MID = "nba:defense_long_mid"
    NBA_DEFENSE_LT_10FT = "nba:defense_lt_10ft"
